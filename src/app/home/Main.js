      ...
      <main id='fullpage'>
          ...
          <div className={styles.hScreen}>
            ...
            <motion.div {...motionProps}>
              <article className="box">
                <div className={`${styles.contentWrap} column`}>
                  <h1 className={`ko ${styles.title}`}>버릇</h1>
                  <div className={`${styles.textBox} description`}>
                    <p>
                      반복하여 몸에 익어 버린 행동, 즉 개인의
                      버릇을 조명한다. 과거에서 형성된 버릇은
                      오늘날의 나를 결정짓고, 우리가 누구인지를
                      정의 할 수 있게 해주는 요인이 된다.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      전체를 이해하려는 노력으로 이어진다. 이
                      전시에서 우리는 삶의 반복된 순간들인 버릇을
          ...
          <div className={styles.hScreen}>
            ...
            <motion.div {...motionProps}>
              <article className={`box ${isMobile ? 'column' : 'row'}`}>
                <div className={`${styles.contentWrap} column`}>
                  <h1 className={`eng ${styles.title}`}>SCANIMATION</h1>
                  <div className={`${styles.textBox} description`}>
                    <p>
        ...
        <section className='section'>
          <div className={styles.hScreen}>
            ...
            <motion.div {...motionProps}>
              <div className={styles.imgMainPoster}>
                <img src="/img/mainPoster.png" alt="#" />
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className='section'>
          <div className={styles.hScreen}>
            ...
            <motion.div {...motionProps}>
              <article className={`box  ${isMobile ? `column ${styles.m_memberDT}` : `row ${styles.memberDT}`}`}>
                <div className={styles.imgMember}>
                  <img src="/img/profileImg/all_profile.png" alt="#" />
                </div>
                <div className={`${styles.textBox} ${styles.memberTxt} description`}>
                  <p>이상화 · 박서해 · 왕신웨 · 이지은 · 김경린 · 김은선</p>
                  <p>박정혜 · 최시아 · 김동성 · 박승찬 · 오여슬 · 이민서 · 조성원</p>
                </div>
              </article>
            </motion.div>
          </div>
        ...
        <section className='section'>
          <div className={styles.hScreen}>
            ...
            <motion.div {...motionProps}>
              <article className={`box ${isMobile ? 'column' : 'row'}`}>
                <div className={`${isMobile ? styles.m_imgMap : styles.imgMap}`}>
                  {isMobile ?
                    <KakaoMap width={350} height={200} /> :
                    <KakaoMap width={300} height={400} />
                  }

                </div>
                <div className={`column ${styles.loc}`}>
                  <h1 className={`eng ${styles.title}`}>오시는 길</h1>
