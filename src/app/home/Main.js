    ...
    <div>
      ...
      <main>
        <div className={styles.hScreen}>
          {inter == false ? <InterBanner onBtnClick={startInter} /> : <Banner onBtnClick={startInter} />}
        </div>
        <section className={`${styles.hScreen}`}>
          ...
          <article className="contentsContainer column">
            <div className={`${styles.captionContainer} ${styles.outline}`}>
              ...
              <p className={styles.endnotes}>부산대학교 Design & Technology 15회 졸업 전시</p>
            </div>
          </article>
        </section>
        ...
        <section className={`${styles.hScreen} ${styles.video}`}>오프닝 영상</section>
        ...
        <section className={`${styles.hScreen}`}>
          ...
          <article className="contentsContainer row">
            ...
            <div className={styles.captionContainer}>
              ...
              <div className={`${styles.txtContainer} description`}>
                <p>첨단 전자 및 컴퓨터 공학을 포함한 기술적인 요소와 예술적 감성의 조화를 필요로 하는 영상물의 분석, 기획, 제작, 편집 기법 및 첨단 컴퓨터 기술의 실용적인 교육을 통해 영화 및 비디오 영상, 디지털 시네마, 디지털 방송 등에 활용되는 디지털콘텐츠 제작 기술 능력을 배양하고, 우수한 디지털콘텐츠를 개발하여 산업화할 수 있는 디자인, 공학 전문 인력을 양성하여 지역사회와 국가의 디지털콘텐츠 산업 발전 및 경쟁력 제고에 이바지함을 목표로 한다. </p>
              </div>
            </div>
        ...
        <section className={`${styles.hScreen}`}>
          ...
          <article className={`${styles.itemContainer}  contentsContainer column`}>
